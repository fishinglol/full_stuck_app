...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      // Send email and password to FastAPI for authentication
      const loginData = { 
  ...
  // Unified success handler for both regular and Google login
  ...
  // Handle other social logins (placeholder)
          ...
          <View style={styles.card}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>
                TRUSTTAG ensures your branded items are real{'\n'}checked by experts 
              </Text>
            </View>
            ...
            <View style={styles.inputSection}>
              ...
              <View style={styles.forgotSection}>
                ...
                >
                  <Text style={styles.forgotText}>sign in here! or </Text>
                </TouchableOpacity>
